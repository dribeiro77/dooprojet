...
public class PlateauDamesChinoises extends Plateau{
	...
	/**
	 * Donne la liste de Cases o� le pion peut sauter � partir de sa case
	 * @param n
	 * @return
	 */
	...
	/**
	 * V�rifie si touts les pions adverses ont atteint le triangle du haut
	 * @return
	 */
	...
	/**
	 * Verifie si touts les pions ont atteint le triangle haut � droit 
	 * @return
	 */
...
/**
 * verifie si tous les pions ont atteint le triangle d'en haut � gauche 
 * @return
 */
...
/**
 * verifie si tous les pions ont atteint le triangle en bas � gauche
 * @return
 */
